...
const firstPage: Buch[] = [
    {
        ...
        titel: {
            ...
            untertitel: 'Pragmatischer Einstieg',
        },
        art: 'PAPERBACK',
        preis: 29.9,
        lieferbar: true,
    ...
    },
    {
        ...
        titel: {
            ...
            untertitel: 'Software strukturieren',
        },
        art: 'HARDCOVER',
        preis: 44.9,
        lieferbar: true,
    ...
    },
    {
        ...
        titel: {
            ...
            untertitel: 'Schnellstart für Projekte',
        },
        art: 'PAPERBACK',
        preis: 24.5,
        lieferbar: true,
...
test.describe('BookSearchFormMUI', () => {
    test.beforeEach(async ({ page }) => {
        ...
        await expect(
            page.getByRole('heading', { name: 'Bücher suchen' }),
        ).toBeVisible();
    });

    test('zeigt initiale Ergebnisse', async ({ page }) => {
        await expect(
            page.getByRole('heading', { name: 'Ergebnisse' }),
        ).toBeVisible();
    ...
    test('öffnet BookDetail beim Klick', async ({ page }) => {
        ...
        await expect(
            page.getByRole('link', { name: 'Zur Homepage' }),
        ).toBeVisible();
    });
});
